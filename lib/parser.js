...
function decode(ticket, verifier, claimsAuth) {
	dbc('string' === typeof ticket, 'parser error -- ticket must be a string');
	dbc('function' === typeof verifier, 'parser error -- verifier must be a function');
