...
function decode(ticket, verifier, resolver) {
	...
	if ('function' !== typeof resolver) throw new Error('parser error -- resolver must be a function');
	...
	return from(result, verifier, resolver);
}
...
function from(data, verifier, resolver) {
	var claimsets = {}
	, knownIdentityValues = {}
	;
...
Object.defineProperties(module.exports, {
	...
	decode: {
		value: function(ticket, verifier, resolver) {
			return decode(ticket, verifier, resolver);
		},
		enumerable: true
	},

	from: {
		value: function (data, verifier, resolver) {
				...
				return from(data, verifier, resolver);
		},
		enumerable: true
	}
